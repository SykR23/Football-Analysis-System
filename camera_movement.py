...
import cv2
import numpy as np
from utils import get_distance, measure_xy_distance
import os
...
class CameraMovementEstimator:
    ...
    def draw_camera_movement(self, frames, camera_movement_per_frame, video_writer):
        output_frames = []
        for frame_num, frame in enumerate(frames):
            overlay = frame.copy()
            cv2.rectangle(overlay, (0,0), (450,80), (255,255,255), -1)
            alpha = 0.6
